...
describe('PublicService', () => {
  it('should generate visitor token', () => {
    function generateVisitorToken(visitorId: string, conversationId: string): string {
...
describe('Handoff Keywords', () => {
  it('should detect Chinese handoff keywords', () => {
    const keywords = ['人工', '转人工', '客服', '投诉', 'human', 'agent', 'support'];
    ...
    expect(keywords.some(k => 'I need human agent'.toLowerCase().includes(k.toLowerCase()))).toBe(true);
  });
